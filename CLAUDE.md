...
Each time you complete a task or learn important information about the project, you should update the `CLAUDE.md` or any `agent.md` file that might be in the project to reflect any new information that you've learned or changes that require updates to these instructions files.
...
10. после одобренного плана нужно создавать задачник в файле todo

11. после каждой выполненной задачи нужно обновлять задачник todo

12. задачи глобальные задачи разбивай на батчи, после написания скриптов батча сначала нужно делать деплой (реализацию), если деплой\реализация успешны (не содержат багов после проверки пользователем), нужно закоммитить в git
